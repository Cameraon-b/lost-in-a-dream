...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<bundler>.freeze, ["~> 1.7.3".freeze])
  s.add_development_dependency(%q<jeweler>.freeze, ["~> 2.0.1".freeze])
  s.add_development_dependency(%q<simplecov>.freeze, ["~> 0.9.0".freeze])
end
